...
typedef struct {																													//Definição da estrutura de um controle (!)
	...
	unsigned char sandevistan;																										//Botão de movimentação para baixo (!)
...
void joystick_x(joystick *element);																								//Protótipo da função de ativação/desativação do botão de movimentação para baixo (!)
